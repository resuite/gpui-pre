...
- crates.io packages: `gpui-pre`, `gpui-pre-apple`, `gpui-pre-macos`, and `gpui-pre-wgpu` 0.3.4
...
- local deltas:
  ...
  - 2D paint transforms across `crates/gpui-pre`, `crates/gpui-pre-apple`, and `crates/gpui-pre-wgpu`
