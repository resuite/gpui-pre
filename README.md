...
These four crates form one patched renderer snapshot and should be pinned to the same repository revision. Keep the Cargo package names unchanged; downstream `[patch.crates-io]` entries rely on them.
